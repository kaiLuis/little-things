...
button_add = Button(root, text='+', padx=40, pady=30, command=button_addition)
button_mult = Button(root, text='*', padx=40, pady=30, command=button_multiply)
button_divide = Button(root, text='/', padx=40, pady=30, command=button_division)
button_sub = Button(root, text='-', padx=41, pady=30, command=button_subtraction)
button_equal = Button(root, text='=', padx=95, pady=30, command=button_upto)
button_clear = Button(root, text='Clear', padx=85, pady=30, command=lambda: button_clean())
